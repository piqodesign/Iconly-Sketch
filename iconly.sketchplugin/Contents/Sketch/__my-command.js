...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/3b9f6c919fac403965a2198c9f97d8b2.html";
...
var webviewIdentifier = 'iconly.webview';
var msgs = ["Keep going! 👌", "Nice choice! 🤩", "Hummm, great! 🔥", "Looks good! 👀", "Here you go! 😎", "Let's do this! 🚀", "That rocks! 🤘"];
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  webContents.on('nativeLog', function (options) {
    var _JSON$parse = JSON.parse(options),
        icon = _JSON$parse.icon,
        name = _JSON$parse.name;

    var group = sketch_dom__WEBPACK_IMPORTED_MODULE_3___default.a.createLayerFromData(icon, "svg");
    group.name = name;
    var document = sketch_dom__WEBPACK_IMPORTED_MODULE_3___default.a.getSelectedDocument();
    ...
    for (var i = 0; i < document.selectedLayers.length; i++) {
      ...
      group.parent = layer;
      sketch_ui__WEBPACK_IMPORTED_MODULE_2___default.a.message(msgs[random(0, msgs.length - 1)]);
      return;
    }

    var page = document.selectedPage; // centerizeGroup(page.frame , group);
